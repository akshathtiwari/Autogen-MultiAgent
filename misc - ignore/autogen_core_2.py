...
class OuterAgent(RoutedAgent):
    ...
    async def on_my_message(self, message: Message, ctx: MessageContext) -> None:
        print(f"Received message: {message.content}") # message.content - > Akshath
...
async def main():
    #create object for SingleThreadedAgentRuntine
    ...
    await runtime.send_message(Message(content="Akshath"), outer_agent_id)
